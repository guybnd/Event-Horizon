...
5. Notify the user that the release was successfully created, the tickets were moved to `Released`, and point them to the generated release notes doc or the Releases view.
