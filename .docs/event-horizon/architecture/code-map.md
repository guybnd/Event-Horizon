...
-   `portal/src/components/TaskCard.tsx` is now a **thin layout** (~162 lines) that
	...
	`CardBranchRow`, `CardCommentPopover`, `CardSubtaskPopover`, `CardDescriptionPopup`, …).
