...
| **REST API (portal-facing)** | [`engine/src/routes/`](../../engine/src/routes) | Planned `reference/rest-api.md` (FLUX-356) | [ADR 0001 — Storage Modes](decisions/0001-storage-modes.md) (storage-related routes) |
| **MCP server (agent-facing)** | [`engine/src/mcp-server.ts`](../../engine/src/mcp-server.ts) | [MCP Server](mcp-server.md), planned `reference/mcp-tools.md` (FLUX-356) | — |
