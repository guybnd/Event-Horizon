...
| **Agent integrations** | [`engine/src/agents/`](../../engine/src/agents), [`engine/src/session-store.ts`](../../engine/src/session-store.ts) | [Agent Integrations](agent-integrations.md), [Agent Adapter Contract](reference/agent-adapter-contract.md), [Agent Spawn Prelude Test Matrix](testing/agent-prelude-matrix.md) | [ADR 0002 — Multi-Agent CLI](decisions/0002-multi-agent-cli.md) |
| **Orchestration / delegation from chat** | [`engine/src/mcp-server.ts`](../../engine/src/mcp-server.ts), [`engine/src/routes/cli-session.ts`](../../engine/src/routes/cli-session.ts) (`delegate`), [`portal/src/hooks/useChatSession.ts`](../../portal/src/hooks/useChatSession.ts), [`portal/src/components/task-modal/ChatView.tsx`](../../portal/src/components/task-modal/ChatView.tsx), [`RunView.tsx`](../../portal/src/components/task-modal/RunView.tsx) | [Chat-Native Orchestration](architecture/chat-native-orchestration.md) | [ADR 0003 — Orchestration Runtime](decisions/0003-orchestration-runtime.md) |
| **Realtime / live updates** | [`engine/src/events.ts`](../../engine/src/events.ts), watchers in [`task-store.ts`](../../engine/src/task-store.ts), [`portal/src/AppContext.tsx`](../../portal/src/AppContext.tsx) | [Realtime Channels](reference/realtime-channels.md) | — |
...
| **Multi-repo groups** (design spec — not yet implemented) | — | [Multi-Repo Groups](architecture/multi-repo-groups.md) | — |
