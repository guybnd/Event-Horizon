...
| **Agent integrations** | [`engine/src/agents/`](../../engine/src/agents), [`engine/src/session-store.ts`](../../engine/src/session-store.ts) | [Agent Integrations](agent-integrations.md), [Agent Adapter Contract](reference/agent-adapter-contract.md) | [ADR 0002 — Multi-Agent CLI](decisions/0002-multi-agent-cli.md) |
