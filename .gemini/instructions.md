...
- The orchestrator skill provides critical rules for ticket resolution, metadata formatting, and workflows. Find it in your agent's rule location (e.g., `.github/skills/event-horizon/orchestrator.md`, `.gemini/skills/event-horizon.md`, `.cursor/rules/event-horizon.mdc`, or `.claude/rules/event-horizon.md`).
