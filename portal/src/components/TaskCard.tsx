...
export const TaskCard = memo(function TaskCard({
  ...
  return (
    <CardContainer
      ...
      className={`mb-4 group flex flex-col relative ${(priorityMenuOpen || effortMenuOpen || assigneeMenuOpen || tagMenuOpen || isEditingTitle || isHovering) ? 'z-40' : ''}`}
