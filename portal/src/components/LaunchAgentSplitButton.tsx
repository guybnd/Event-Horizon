    ...
    return (
      <div ref={containerRef} className="relative flex">
        <button
          ...
          disabled={isDisabled}
          onClick={() => onLaunch()}
          className="eh-btn-accent flex items-center gap-1.5 rounded-l-lg px-3 py-1.5 text-xs font-semibold transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <button
          ...
          disabled={isDisabled}
          onClick={() => setOpen((v) => !v)}
          className="eh-btn-accent flex items-center justify-center rounded-r-lg border-l border-white/20 px-1.5 py-1.5 text-xs transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
